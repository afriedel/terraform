...
func TestCredentialsStoreForget(t *testing.T) {
	...
	cfg := &Config{
		...
		// in some file _other than_ credentials.tf.json.
	...
	// Now we'll switch to having a credential helper active. Note that the
	// credentials.tfrc.json file is still present and has the stored-locally
	// credential in it.
